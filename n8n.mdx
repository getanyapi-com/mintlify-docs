...
<AccordionGroup>
  ...
  <Accordion title="List APIs - browse the catalog" icon="list">
    Browse the AnyAPI catalog, optionally narrowed with **Query** (free-text over name and
    description) and **Category** (a category slug). Returns one item per matching API.
  </Accordion>
