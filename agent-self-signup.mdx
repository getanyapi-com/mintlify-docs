...
Nothing, and nothing is owed. A trial key carries a budget of about **$0.05 of requests**
...
<Tabs>
  ...
  <Tab title="Dashboard key (secondary)">
    ...
    **non-expiring** key directly at
    ...
    agent via the `ANYAPI_API_KEY` environment variable. New accounts start with about
    **100 free requests**. This is the path to use on a CLI too old for `anyapi connect`.
  </Tab>
</Tabs>

## Why this is safe

- The trial budget bounds what an unapproved agent can spend - about $0.05, no more.
