...
This guide takes you from signup to a live response. If you have a shell, install the CLI first.
Hosted Claude and ChatGPT use the remote MCP URL only and OAuth sign-in and consent. A Bearer API
key is the fallback for clients without OAuth.
