...
<Steps>
  ...
  <Step title="Read the response">
    ...
    <Note>
      ...
      matched nothing; a suspended account says `"reason": "suspended"`. The reason is one
      word from a fixed list published in every API's output schema. You are charged for it only when the
