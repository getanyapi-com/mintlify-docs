...
<Steps>
  ...
  <Step title="Read the response">
    ...
    <Note>
      ...
      and it is charged like any other result, because most sources charge for the lookup
      whether or not they find anything. Failed calls are never charged, and `costUsd` is
      always what this call actually cost you - `0` when nothing was charged for it.
    </Note>
  </Step>
</Steps>
