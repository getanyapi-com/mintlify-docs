...
| | |
|---|---|
| **Endpoint** | `https://api.anyapi.dev/mcp` |
...
- An AnyAPI key. Create one in the [dashboard](https://app.anyapi.dev) under **API keys**.
...
<Tip>
  Need help? Reach out at [support@anyapi.dev](mailto:support@anyapi.dev).
</Tip>
