...
<Info>
  **Which page do you want?** This page is for **integrating AnyAPI into your app** — your
  coding agent uses a [dashboard key](https://getanyapi.com/dashboard/keys) on your funded
  account, and the app is the caller in production. If instead you're running an
  **autonomous agent that calls AnyAPI itself at runtime**, it can provision its own key —
  see [Let your agent onboard itself](/agent-self-signup).
</Info>
...
<Steps>
  <Step title="Create an API key">
    In the [dashboard](https://getanyapi.com/dashboard) under **API keys**, and fund your USD
    wallet.
  </Step>
