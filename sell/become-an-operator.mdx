...
*schema*), and the ones you can register yourself are listed in
[APIs open to sellers](/sell/apis/index); to sell any other one, email
[support@getanyapi.com](mailto:support@getanyapi.com). You host an HTTPS endpoint that
speaks the API's format, set your own price, and
...
<Steps>
  ...
  <Step title="Build your endpoint">
    Pick one of the [APIs open to sellers](/sell/apis/index), read its request/response
    format, and deploy an
